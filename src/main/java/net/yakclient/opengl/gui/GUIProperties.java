...
public class GUIProperties {
    private final Map<PropertyNode, Object> props;

    public GUIProperties(Map<PropertyNode, Object> props) {
        this.props = props;
    }
    ...
    @SuppressWarnings("unchecked")
    @Nullable
    public <T> T get(int value) {
        return (T) this.retrieve(new IntPartialNode(value));
    }
     ...
     */
    public void iterateProps(BiConsumer<PropertyNode, Object> iterator) {
    ...
    /**
     * Determines if the given value is stored
     * in the current properties.
     *
     * @param value the value of the property.
     * @return if the property is found.
     */
    public boolean hasProperty(int value) {
        return this.get(value) != null;
    }

    @Nullable
    private Object retrieve(PartialNode partial) {
        for (PropertyNode node : this.props.keySet()) {
            if (partial.isSame(node)) return this.props.get(node);
        }
        return null;
    }
